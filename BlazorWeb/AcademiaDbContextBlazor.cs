...
namespace BlazorWeb
{
    public class AcademiaDbContextBlazor : DbContext
    {
        public AcademiaDbContextBlazor()
        {
        }

        public AcademiaDbContextBlazor(DbContextOptions<AcademiaDbContextBlazor> options)
            : base(options)
        {
        }
